    ...
    return (
        <div className=' font-bold flex flex-wrap justify-center'>
            {repos && repos.map((repo) => (
                ...
                <a href={repo.node.url} target="_blank" key={repo.node.id} style={{"flex-basis":"33.333%"}} className="block max-w-sm p-6 m-2 h-48 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-black dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p className="font-normal text-gray-700 dark:text-gray-400 w-full max-h-20 overflow-hidden overflow-ellipsis overflow-y-clip text-left">{repo.node.description} sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss sssssssssssssssssssssssssssssssssssssssssssssssssssssssssss</p>
